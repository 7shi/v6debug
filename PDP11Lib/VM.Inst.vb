...
Partial Public Class VM
    ...
    Private Sub Exec0()
        ...
        Select Case v1
            ...
            Case 4 ' jsr: Jump to SubRoutine
                ...
                Dim dst = GetSrc(2).GetAddress(Me)
            ...
            Case 5
                Select Case v2
                    ...
                    Case 6 ' sbc: SuBtract Carry
                        ...
                        Return
                    Case 7 ' tst: TeST
                        Dim dst = ConvShort(GetSrc(2).GetValue(Me))
    ...
    Private Sub Exec7()
        ...
        Select Case (v >> 9) And 7
            ...
            '    End Select
            Case 0 ' mul: MULtiply
                Dim src = ConvShort(GetSrc(2).GetValue(Me))
                Dim r = (v >> 6) And 7
            ...
            Case 2 ' ash: Arithmetic SHift
                Dim src = GetSrc(2).GetValue(Me) And &O77
                Dim r = (v >> 6) And 7
    ...
    Private Sub Exec10()
        ...
        Select Case (v >> 6) And &O77
            ...
            Case &O57 ' tstb: TeST Byte
                Dim dst = ConvSByte(GetSrc(1).GetByte(Me))
                SetFlags(dst = 0, dst < 0, False, False)
                Return
